...
public class HospitalManagementSystems {
    ...
    private static final String password = "Shreeram@7";
    ...
    private static boolean checkDoctorAvailablity(int doctorId, String appointmentDate, Connection connection) {
